 ...
 */
@Schema(description = "Map (string-to-string dictionary) of key value pairs of trailers ")
@Validated
@NotUndefined
...
public class Trailers extends HashMap<String, String>  {
